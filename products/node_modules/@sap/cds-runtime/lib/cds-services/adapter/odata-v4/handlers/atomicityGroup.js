...
const start = (odataContext, done) => {
  ...
  odataContext.applicationData.atomicityGroup = odataContext.applicationData.atomicityGroup || {}
  odataContext.applicationData.atomicityGroup[odataContext.id] = 1
...
const end = async (odataErr, odataContext, done) => {
  ...
  delete odataContext.applicationData.atomicityGroup[odataContext.id]
